...
\subsection{vimrc}
\lstinputlisting{1_Basic/vimrc.tex}
...
\lstinputlisting{2_Graph/Minimum_Mean_Cycle.cpp}
...
\lstinputlisting{2_Graph/Minimum_Steiner_Tree.cpp}
...
\lstinputlisting{2_Graph/Number_of_Maximal_Clique.cpp}
% \subsection{Theory}
% \begin{footnotesize}
...
\lstinputlisting{3_Data_Structure/lichao.cpp}
\subsection{Persistent Segment Tree}
\lstinputlisting{3_Data_Structure/per_seg.cpp}
\subsection{Treap}
...
\lstinputlisting{4_Flow_Matching/KM.cpp}
...
\lstinputlisting{5_String/palindromic_tree.cpp}
...
\lstinputlisting{6_Math/Simplex.cpp}
...
\lstinputlisting{7_Polynomial/FFT.cpp}
\subsection{Number Theory Transform}
\lstinputlisting{7_Polynomial/NTT.cpp}
\subsection{Fast Walsh Transform*} % test by luogu P6097
\lstinputlisting{7_Polynomial/FWT.cpp}
